      ...
      <div className="card w-full lg:w-96 bg-sky-950 text-white shadow-xl border-2 border-orange-600 mx-auto"data-aos="zoom-in">
        <div className="card-body">
          ...
          <div className="card-actions justify-start">
            <button className="btn btn-outline text-white border-orange-600 hover:bg-sky-700">Book Now</button>
          </div>
        </div>
      </div>
        {/* card 02 */}
      <div className="card w-full lg:w-96 bg-sky-950 text-white shadow-xl border-2 border-orange-600 mx-auto"data-aos="fade-up">
        <div className="card-body">
